...
describe('initialRoleForEmail', () => {
  it('should_return_admin_when_email_matches_seed_admin', () => {
    expect(
      initialRoleForEmail('boss@dealershipaccelerator.io', 'boss@dealershipaccelerator.io'),
    ).toBe('admin');
  });
  ...
  it('should_return_viewer_when_email_does_not_match_seed_admin', () => {
    expect(
      initialRoleForEmail('user@dealershipaccelerator.io', 'boss@dealershipaccelerator.io'),
    ).toBe('viewer');
  });
